    ...
    def next(self):
        ...
        #wygładzanie
            ...
            if self.line.idx > self.warmup and today > self.pip_av_days and today > self.n_days and today>self.av_VIX_days:
                ...
                #self.VIX = self.datas[6].close[0]
                self.carry_sum_daily = self.Pair1_swap_long + self.Pair2_swap_long
                ...
                #średnia wygładzania od początku
                    ...
                    if self.ticket is not None:
                        ...
                        self.carry2 = ((self.Pair2_swap_long * self.vol2 * self.datas[1].close[0])/self.datas[1].close[0])
            ...
            if self.ticket is not None:
                ...
                self.pair2_carry.append((self.Pair2_swap_long * self.vol2 * self.datas[1].close[0])/self.datas[1].close[0])
